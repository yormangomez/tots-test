enum LoginErrorEnum {
  ...
  error1005(
    ...
    errorDescription:
        'Deberás recuperar tu contraseña para acceder nuevamente.',
  ...
  error1000(
    ...
    errorDescription:
        'Para ingresar deberás registrarte con tus datos y número de credencial.',
  ...
  errorNoProduct(
    ...
    errorDescription:
        'Para acceder deberás vincular tu cobertura de Swiss Medical Medicina Privada completando tu número credencial.',
