            ...
            Checkbox(
              ...
              fillColor: widget._onChanged != null
                  ? WidgetStateProperty.all(
                      widget._valueCheckbox ? AppColors.primaryYello : null)
                  : null,
            ),
      ...
      text: TextSpan(
        children: [
          TextSpan(
              ...
              style: UITextStyle.paragraphs.paragraph2Regular.copyWith(
                color:
                    widget._errorActive! ? AppColors.error : AppColors.black4,
              )),
          TextSpan(
            text: ' ${widget._linkLabel}',
            recognizer: TapGestureRecognizer()..onTap = widget._onLinktapped,
            style: UITextStyle.paragraphs.paragraph2SemiBold
                .copyWith(color: AppColors.primaryYello),
          ),
        ],
      ),
    );
